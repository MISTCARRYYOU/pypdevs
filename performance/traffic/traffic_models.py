...
class RoadSegment(AtomicDEVS):
    def __init__(self, district, l = 100.0, v_max = 18.0, observ_delay = 0.1, name = "RoadSegment"):
        AtomicDEVS.__init__(self, name)
...
class Road(CoupledDEVS):
    def __init__(self, district, name="Road", segments=5):
        CoupledDEVS.__init__(self, name)
        self.segment = []
        for i in range(segments):
            self.segment.append(self.addSubModel(RoadSegment(district=district, name=(name + "_" + str(i)))))
